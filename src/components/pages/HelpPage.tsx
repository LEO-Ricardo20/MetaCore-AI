...
const CHANGELOG = [
  {
    ...
    badge: 'emerald',
      changes: [
        '新增：AI 候选型号流程，一键获取最常用、最优、最有性价比和最好四类方案',
        '新增：四类选型偏好可拖动分配 0–100 点，总分严格保持为 100',
        '新增：AI 自动选择型号和按已选型号一键生成方案',
        '安全：候选先经过电压、电流、温升、资料完整性和供应稳定性门槛，未确认的器件不会被静默替换',
        '优化：已选型号、选型权重和安全摘要随项目保存，重新生成时可复核',
