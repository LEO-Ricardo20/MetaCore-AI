...
import { Activity, AlertTriangle, ArrowRight, BookOpen, CheckCircle2, CircleDashed, Cpu, FolderOpen, HardDrive, Play, Plus, RefreshCw, ShieldAlert, Sparkles, Wrench, XCircle } from 'lucide-react'
      ...
      <div className="page-container tone-workspace">
        <header className="workspace-header flex flex-wrap items-start justify-between gap-4">
          ...
          <div className="flex flex-wrap gap-2">
            <Link to="/help" className="inline-flex items-center gap-2 rounded-[var(--radius-control)] border border-cyan-400/30 bg-cyan-500/10 px-3.5 py-2 text-sm font-medium text-cyan-200 hover:border-cyan-300/60" aria-label="打开新手教程">
              <BookOpen size={15} /> 新手教程
            </Link>
